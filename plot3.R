...
with(crn, plot(Sub_metering_1~Datetime, type= "l",ylab="Global Active Power (kilowatts)", xlab=""))

lines(Sub_metering_2~Datetime, data = crn, col="red")
lines(Sub_metering_3~Datetime, data = crn, col="blue")
